...
function buildProductOptions (res) {
    ...
    for (var i=0; i < res.length; i++) {
        ...
        // covert option values to boolean
        if (productOption.optionValue === 'true') {
            productOption.optionValue = true
        }
        else if (productOption.optionValue === 'false') {
            productOption.optionValue = false
        }
